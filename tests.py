...
class CalendarTestCase(unittest.TestCase):
    ...
    def test_submit_schedule_function_insert_date_into_template_correctly(
        self
    ):

        user_input = ["2019", "2", "1", "2", "3", "y"]
    ...
    def test_create_correct_new_calendar_in_output_folder(self):
        ...
        self.assertTrue(
            os.path.exists(f'./output/{schedule["name"]}')
        )
